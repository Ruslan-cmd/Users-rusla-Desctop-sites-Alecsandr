...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="{{asset('/docs/4.5/dist/css/bootstrap.min.css')}}" rel="stylesheet" integrity="sha384-JcKb8q3iqJ61gNV9KGb8thSsNjpSL0n8PARn9HuZOnIxN0hoP+VmmDGMN5t9UJ0Z" crossorigin="anonymous">
...
<main role="main">
    ...
    <div>
        <h1 style="margin-top: 50px;color:black;font-size: 50px">Ваша сессия: {{session()->getID()}}</h1>
...
<script>window.jQuery || document.write('<script src="{{asset('/docs/4.5/assets/js/vendor/jquery.slim.min.js')}}"><\/script>')</script><script src="/docs/4.5/dist/js/bootstrap.bundle.min.js" integrity="sha384-LtrjvnR4Twt/qOuYxE721u19sVFLVSA4hf/rRt6PrZTmiPltdZcI7q7PXQBYTKyf" crossorigin="anonymous"></script></body>
</html>
